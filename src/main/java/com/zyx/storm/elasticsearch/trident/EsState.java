 ...
 */
package com.zyx.storm.elasticsearch.trident;

import backtype.storm.topology.FailedException;
import com.zyx.storm.elasticsearch.common.EsConfig;
import com.zyx.storm.elasticsearch.common.EsTupleMapper;
import com.zyx.storm.elasticsearch.common.StormElasticSearchClient;
...
class EsState implements State {
    ...
    /**
     * @param txid Elasticsearch index requests with same id will result in update operation
