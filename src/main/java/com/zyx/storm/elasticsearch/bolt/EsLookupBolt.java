 ...
 */
package com.zyx.storm.elasticsearch.bolt;

import backtype.storm.topology.OutputFieldsDeclarer;
import backtype.storm.tuple.Tuple;
import backtype.storm.tuple.Values;
import com.google.common.base.Preconditions;
import com.zyx.storm.elasticsearch.ElasticsearchGetRequest;
import com.zyx.storm.elasticsearch.EsLookupResultOutput;
...
public class EsLookupBolt extends AbstractEsBolt {
    ...
    public EsLookupBolt(EsConfig esConfig, ElasticsearchGetRequest getRequest, EsLookupResultOutput output) {
        super(esConfig);
        Preconditions.checkNotNull(getRequest);
